            ...
            for i in range(sample_size):
                ...
                for xbin in range(1,rpf_xnbins+1):
                    for ybin in range(1,rpf_ynbins+1):
                        ...
                        if self.recycleAll:
                            # Remap to [-0.5,0.5]
                            x_center_mapped = (thisXCenter - self.newXbins['LOW'][0])/(self.newXbins['HIGH'][-1] - self.newXbins['LOW'][0])-0.5
                            y_center_mapped = (thisYCenter - self.newYbins[0])/(self.newYbins[-1] - self.newYbins[0])-0.5
