...
\section{Prerequisites}
    ...
    %     \item \verb"cmsenv"
    % \end{itemize}
    The only environement this software has been tested in is CMSSW\textunderscore 8\textunderscore 1\textunderscore 0 on CMSLPC. The Higgs Analysis Combine Tool must be installed. To set this up on CMSLPC, follow the below recipe:

    \begin{itemize}
        \item \verb"cmsrel CMSSW_8_1_0"
        \item \verb"cd CMSSW_8_1_0/src"
        \item \verb"cmsenv"
        \item \verb"scram b -j 10"
        \item \verb"git clone https://github.com/cms-analysis/HiggsAnalysis-CombinedLimit.git" \verb"HiggsAnalysis/CombinedLimit"
        \begin{itemize}
        ...
        \item \verb"cat env_standalone.sh | sed 's/=/ /g' | sed 's/export/setenv/g' > env_standalone.csh"
        \item \verb"source env_standalone.csh"
        \item \verb"make -j 8; make; scram b -j 10"
        \item \verb"cmsenv"
    \end{itemize}
