...
\section{Prerequisites}
    ...
    %     \item \verb"cmsenv"
    % \end{itemize}
    2D Alphabet has only been tested in a CMSSW environment. The Higgs Analysis Combine Tool must be installed. Please follow the instructions in the Combine documentation \footnote{\verb"https://cms-hcomb.gitbooks.io/combine/content/part1/"} to setup the prerequisite software.
...
\section{Installation}
    ...
    It's a good idea to run \verb"combine --help" again and if you're feeling uneasy, try to call RooParametricHist2D in interactive python to ensure everything is working.
