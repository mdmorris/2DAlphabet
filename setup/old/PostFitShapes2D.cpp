...
int main(int argc, char* argv[]) {
  ...
  */
  ...
  if (vm.count("help")) {
    cout << config << "\nExample usage:\n";
    cout << "PostFitShapes2D -d htt_mt_125.txt -o htt_mt_125_shapes.root -m 125 "
  ...
  for (auto bin : bins) {
    ...
    cmb_bin.Set2DPdfBins(cmb_bin.GetObserved2DShape().GetNbinsX(),cmb_bin.GetObserved2DShape().GetNbinsY());
